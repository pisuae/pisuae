...
const allCategories = ['all', 'clothing', 'makeup', 'combo', 'toys', 'kitchen', 'furniture', 'phones', 'laptops', 'motherboards', 'storage', 'displays', 'batteries', 'memory', 'keyboards', 'processors', 'cooling', 'chargers', 'accessories'];
